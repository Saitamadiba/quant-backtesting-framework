...
A strategy with positive average R per trade may earn materially more in some regimes and lose in others. Aggregate metrics hide this. Regime-conditional analysis exposes it.
...
| Win Rate | 56.8% |
| Profit Factor | 1.67 |
| Mean R-Multiple | (see internal report) |
