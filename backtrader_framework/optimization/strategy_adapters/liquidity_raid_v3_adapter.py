...
v3 redesign rationale (an internal OOS audit):
    1. HMM regime analysis identified favorable vs adverse regimes with material edge separation.
       → NEW: Per-bar regime score hard gate filters adverse-regime entries.

    2. Signal decay analysis showed holding-period gradient:
       short holds underperformed and long holds outperformed in internal analysis.
